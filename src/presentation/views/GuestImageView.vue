        ...
        <div class="bg-background-card border border-white/10 rounded-2xl p-4 md:p-8 shadow-2xl backdrop-blur-sm mb-8">
          ...
          <div class="mb-8">
            <label class="block text-text-primary font-semibold mb-3 text-base md:text-lg">
              ...
              <span class="ml-2 px-2 py-0.5 bg-accent-gold/20 text-accent-gold rounded text-xs">🔒 Registro Requerido</span>
            </label>
              ...
              >
                <div class="text-center">
                  ...
                  <span class="text-primary font-semibold group-hover:text-primary-light transition-colors">
                    Regístrate para usar prompts personalizados
                  </span>
                </div>
              </button>
            ...
            <div>
              ...
              >
                <div class="text-center">
                  <div class="text-4xl mb-2">🔒</div>
                  <span class="text-primary font-semibold group-hover:text-primary-light transition-colors">
                    Regístrate para usar negative prompts
                  </span>
                </div>
              </button>
              <p class="text-text-tertiary text-sm mt-2">
              ...
              <div v-if="showAdvancedOptions" class="space-y-6">
                ...
                <div>
                  <label class="block text-text-secondary font-medium mb-3 text-sm">
                    ...
                    <span class="ml-2 px-2 py-0.5 bg-accent-gold/20 text-accent-gold rounded text-xs">🔒 Premium</span>
                  </label>
                  ...
                  >
                    <div class="text-center">
                      ...
                      <span class="text-accent-gold font-semibold group-hover:text-accent-gold/80 transition-colors">
                        Solo usuarios Premium pueden usar esta opción
                      </span>
                    </div>
                  </button>
